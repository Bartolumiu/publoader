...
| --- | --- | --- |
| **Canonical** | Irreplaceable. Losing a row loses information no other system holds. | `bundles`, `uploaded_chapters`, `uploaded_ids`, `edited_chapters`, `unavailable_chapters`, `deleted_chapters`, `tracked_manga`, `extension_configs`, `schedule_entries`, `settings`, `admin_users`, `api_tokens`, `audit_events`, `workers`, `disabled_extensions` |
